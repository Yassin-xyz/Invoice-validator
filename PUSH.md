...
```
https://github.com/Yassin-xyz/Invoice-validator.git
```

Si vous repartez d'un clone vierge, ou pour (re)pointer le remote :

```bash
git remote add origin https://github.com/Yassin-xyz/Invoice-validator.git
# ou, si origin existe déjà :
git remote set-url origin https://github.com/Yassin-xyz/Invoice-validator.git
